        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {!loading && (data === null || data.count === 0) && (
            <div className="flex flex-col items-center justify-center gap-4 text-center px-6 py-10">
              ...
              <p className="text-white font-bold text-sm">No weekly signals yet</p>
              <p className="text-[#8888aa] text-xs max-w-[220px]">
                Weekly signals are computed every Monday. Run manually:
              </p>
              <pre className="bg-[#0d0d14] text-[#00e676] text-xs px-3 py-2 rounded border border-[#2e2e50] font-mono text-left leading-5 whitespace-pre">
                {"WEEKLY_DRY_RUN=true\npython weekly_signal_pipeline.py"}
              </pre>
              <p className="text-[#555570] text-xs">
                Or wait for the Monday 10:30 AM ET cron.
              </p>
            </div>
          )}
